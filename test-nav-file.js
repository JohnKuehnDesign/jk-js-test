console.log("%cJK Deep Nav Single Pane Test - jk git 5-13-25 v0.1",
  ...
  /***
   * Multi-Level Menu with GSAP & Webflow (Tricks)
   * https://www.youtube.com/watch?v=ev_i3Et10_s
   * 
   ***/
    ...
    if (window.innerWidth <= 991) {
      ...
      let showDeepMenuL2 = gsap.timeline({
        ...
        onComplete: () => {
          ...
          console.log("showDeepMenuL2 Complete!")
          console.log("Previously Focused:", previouslyFocused);
          console.log("Sub Navs Level 2:", deepNavsL2);
        ...
        onReverseComplete: () => {
          ...
          console.log("showDeepMenuL2 Reversed!");
          console.log("Active Level:", activeLevel);
        }
      });
      ...
      let showSubMenuL1 = gsap.timeline({
        ...
        onComplete: () => {
          ...
          console.log("showSubMenuL1 Complete!")
          console.log("Previously Focused:", previouslyFocused);
          console.log("Sub Navs Level 1:", subNavsL1);
          console.log("Active Submenu:", activeSubmenu);
          console.log("Active Level:", activeLevel);
        ...
        onReverseComplete: () => {
          ...
          console.log("showSubMenuL1 Reversed!")
          console.log("Active Level:", activeLevel);
      ...
      backButton.on("click", function () {
        console.log("Back Button Clicked. Active Level:", activeLevel);
        if (activeLevel == 2) {
          activeLevel = 1;
          showDeepMenuL2.reverse();
          /* still need to update to previous submenu here */
          console.log("Back Button with activeLevel = 2");
        } else if (activeLevel == 1) {
          activeLevel = null;
          showSubMenuL1.reverse();
          console.log("Back Button with activeLevel = 1");
  
        }
  
        console.log("Active Level after Back Button Code Complete:", activeLevel);
      ...
      $('[data-controls-submenu-level="1"]').on('click', function () {
        ...
        console.log("Submenu Animation Level 1 On Click Running")
      ...
      $('[data-controls-submenu-level="2"]').on('click', function () {
        ...
        console.log("DeepMenu Animation Level 2 On Click Running")
